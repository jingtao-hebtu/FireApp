...
namespace TF {
    ...
    QJsonObject HKCamZmqClient::BuildRequestObject(const std::string& op, const QJsonObject& params,
                                                   int requestId) const {
        QJsonObject req;
    ...
    RpcResponse HKCamZmqClient::ParseResponse(const std::string& payload, bool& parseOk,
    ...
    RpcCallResult HKCamZmqClient::Call(const std::string& op, const QJsonObject& params) {
        ...
        try {
            ...
            const auto sent = m_socket->send(reqMsg, zmq::send_flags::none);
            if (!sent.has_value()) {
            ...
            zmq::message_t reply;
            const auto received = m_socket->recv(reply, zmq::recv_flags::none);
    ...
    bool HKCamZmqClient::ZoomStep(double step, std::optional<double> speed, QJsonObject& outRaw,
                                  std::string& outError) {
        QJsonObject params;
    ...
    bool HKCamZmqClient::SetZoomAbs(double zoom, std::optional<double> speed, QJsonObject& outRaw,
                                    std::string& outError) {
        QJsonObject params;
    ...
    bool HKCamZmqClient::SetExposureByShutter(const std::string& shutter, bool persist, bool clamp, QJsonObject& outRaw,
                                              std::string& outError) {
        QJsonObject params;
    ...
    bool HKCamZmqClient::SetExposureBySeconds(double exposureSeconds, bool persist, bool clamp, QJsonObject& outRaw,
                                              std::string& outError) {
        QJsonObject params;
    ...
    bool HKCamZmqClient::SetExposureByMicroseconds(double exposureMicroseconds, bool persist, bool clamp,
                                                   QJsonObject& outRaw, std::string& outError) {
        QJsonObject params;
    ...
    bool HKCamZmqClient::ZoomStepAutoFocus(double step, std::optional<double> speed, const QJsonObject& extraParams,
                                           QJsonObject& outRaw, std::string& outError) {
